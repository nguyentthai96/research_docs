...
| `tw.hsra.article-7.committee-composition` | `Luật Nghiên cứu trên Cơ thể Người Điều 7` | `research_institution_or_review_committee` | `["committee_governance", "pathway_trace"]` | Review-committee composition | [Luật Nghiên cứu trên Cơ thể Người Điều 7 (Human Subjects Research Act Art. 7)](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0020176) |
| `tw.hsra.article-14.consent-information` | `Luật Nghiên cứu trên Cơ thể Người Điều 14` | `principal_investigator` | `["participant_information", "submission_packet", "pathway_trace"]` | Information explained before consent | [Luật Nghiên cứu trên Cơ thể Người Điều 14 (Human Subjects Research Act Art. 14)](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0020176) |
