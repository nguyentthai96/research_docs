...
|-----------|------------------|--------|---------|
| **State** (Tuyên bố) | Clarifying + Probing | Before presenting data/evidence | Collect user's prediction or self-assessment |
| **Challenge** (Thách thức) | Structuring + Challenging | After commitment collected | Present information that tests the commitment |
| **Reflect** (Phản tư) | Probing + Structuring | After divergence revealed | Guide user to self-explain the gap |
