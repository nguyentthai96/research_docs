...
| User says "let's keep exploring" / "I'm not sure yet" / "không vội" | Yes | No |
| User says "help me plan" / "I need to write" / "giúp tôi lập kế hoạch" | No | Yes |
...
- **Disable**: User says anything like "skip the predictions", "don't ask me to predict", "thảo luận trực tiếp", "bỏ qua dự đoán", "không cần hỏi tôi dự đoán"
- **Re-enable**: User says anything like "ask me to predict again", "turn predictions back on", "bật lại dự đoán", "hỏi tôi dự đoán lại"
