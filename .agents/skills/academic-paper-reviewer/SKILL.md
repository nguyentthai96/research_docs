...
description: "Multi-perspective academic paper review with dynamic reviewer personas. Runs a 5-seat, role-separated review panel (Journal-Fit Reviewer + 3 peer-review roles + Devil's Advocate) with field-specific expertise; role separation is not a claim of independent error processes. Supports full review, re-review (verification), quick assessment, methodology focus, Socratic guided, and calibration modes. Triggers on: review paper, peer review, manuscript review, referee report, review my paper, critique paper, simulate review, editorial review, calibrate reviewer, reviewer calibration, measure reviewer accuracy, đánh giá bài nghiên cứu, phản biện, mô phỏng phản biện, đồng nghiệp phản biện, giúp tôi đánh giá bài này, đánh giá từ góc độ người phản biện, hiệu chuẩn người phản biện."
metadata:
  version: "1.11.1"
...
**Tiếng Việt**: đánh giá bài nghiên cứu, phản biện, mô phỏng phản biện, đồng nghiệp phản biện, giúp tôi đánh giá bài này, báo cáo phản biện, đánh giá bản thảo, đánh giá từ góc độ người phản biện, hiệu chuẩn người phản biện, đo độ chính xác phản biện
