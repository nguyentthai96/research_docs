...
**Tiếng Việt**: viết bài nghiên cứu, bài học thuật, dàn ý bài nghiên cứu, viết tóm tắt, sửa bài nghiên cứu, bài tổng quan tài liệu, kiểm tra trích dẫn, chuyển sang LaTeX, chuyển đổi định dạng, bài hội nghị, bài tạp chí, luận văn, bài nghiên cứu, hướng dẫn tôi viết bài, giúp tôi lập kế hoạch bài viết, viết bài từng bước, viết phương pháp, viết phần thảo luận, ý kiến phản biện, lộ trình sửa bài, giúp tôi sửa bài, tôi nhận được ý kiến phản biện, chuyển đổi định dạng trích dẫn
...
| Abstract | Bilingual (vi + EN) | Single language |
...
| 7 | `abstract_bilingual_agent` | Bilingual abstract (vi + EN), 5-7 keywords each | Phase 5b |
...
- Disclosure (v3.2): `disclosure_mode_protocol` (default venue applicability/status bundle: `REQUIRED`, `ACTION_ONLY`, `NOT_REQUIRED`, `UNKNOWN`, plus typed halts; separate policy-anchor rendering), `venue_disclosure_policies` (v2 database: ICLR, NeurIPS, Nature, Science, ACL, EMNLP, plus medical-publishing policy targets — ICMJE, NEJM, The Lancet, JAMA, BMJ, PLOS, Frontiers, publisher-wide Chinese Nursing Journals Publishing House, journal-level International Eye Science)
...
**Examples** (9 files in `examples/`): `imrad_hei_example`, `literature_review_example`, `plan_mode_guided_writing`, `vietnamese_paper_example`, `revision_mode_example`, `revision_recovery_example`, `clinical_citation_verification_checklist`, `clinical_epistemic_status_example`, `version_family_reconciliation_example`.
...
6. **Independent writing** — vi and EN abstracts are independently composed, NOT mechanical translations
...
9. **Word count** — EN: 150-300 words; vi: 200-400 words
